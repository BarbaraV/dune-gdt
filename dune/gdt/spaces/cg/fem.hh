...
public:
  ...
  typedef Mapper::FemDofWrapper< typename BackendType::BlockMapperType, rangeDim > MapperType;
...
class FemBased< GridPartImp, polynomialOrder, RangeFieldImp, rangeDim, 1 >
  : public Spaces::CGInterface< FemBasedTraits< GridPartImp, polynomialOrder, RangeFieldImp, rangeDim, 1 >,
                                GridPartImp::dimension, rangeDim, 1 >
{
  typedef Spaces::CGInterface< FemBasedTraits< GridPartImp, polynomialOrder, RangeFieldImp, rangeDim, 1 >,
                               GridPartImp::dimension, rangeDim, 1 >           BaseType;
